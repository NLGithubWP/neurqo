        ...
        for column in column_statistics:
            ...
            for slot_number in range(1, 6):
                ...
                if kind == 1:  # STATISTIC_KIND_MCV
                    column["most_common_vals"] = slots[
                        f"stavalues{slot_number}"
                    ]
                    column["most_common_freqs"] = slots[
                        f"stanumbers{slot_number}"
                    ]
                elif kind == 2:  # STATISTIC_KIND_HISTOGRAM
                    column["histogram_bounds"] = slots[
                        f"stavalues{slot_number}"
                    ]
